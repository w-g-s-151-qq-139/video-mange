        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath }/course/index.action?subjectId=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath }/course/index.action?subjectId=6">
                        ...
                        <td rowspan="2" class="one_three">
                            <a href="${pageContext.request.contextPath }/course/index.action?subjectId=2" class="opacity5">
                    ...
                    <tr>
                        <td>
                            <a href="${pageContext.request.contextPath }/course/index.action?subjectId=5" class="opacity5">
                        ...
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath }/course/index.action?subjectId=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath }/course/index.action?subjectId=11">
