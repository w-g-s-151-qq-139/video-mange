...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div style="float: left;">
				<ul class="nav nav-pills">
					...
					<a href="${pageContext.request.contextPath }/admin/altspeaker.action">添加主讲人</a></li>
				</ul>
			</div>
			<div style="float: right;">
				<form
					action="${pageContext.request.contextPath }/admin/searchspeaker.action"
					class="form-inline">
		...
		<table class="table table-hover table-condensed">
			...
			<c:forEach items="${page.rows }" var="l" varStatus="status">
				<tr>
					<td>${status.count }</td>
					<td>${l.speakerName }</td>
					<td>${l.speakerJob }</td>
					...
					<td><a class="glyphicon glyphicon-edit"
						href="${pageContext.request.contextPath }/admin/altspeaker.action?id=${l.id }"></a></td>
					<td><a class="glyphicon glyphicon-trash"
						onclick="return(confirm('确认删除?'));"
						href="${pageContext.request.contextPath }/admin/delspeaker.action?id=${l.id }"></a></td>
				</tr>
			</c:forEach>
		</table>
